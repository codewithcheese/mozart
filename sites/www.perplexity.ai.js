...
function inputPrompt({ prompt }) {
  ...
  const promptInput = document.querySelector('[placeholder="Ask anything..."]')
  if (promptInput && (promptInput.tagName === 'INPUT' || promptInput.tagName === 'TEXTAREA')) {
...
function submitPrompt() {
  ...
  const sendButton = document.querySelector('[data-icon="arrow-right"]').parentElement.parentElement;
  if (sendButton) {
      sendButton.click();
  } else {
